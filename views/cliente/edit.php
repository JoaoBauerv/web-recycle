...
if (!$cliente) {
    header("Location: index.php?msgErro=Cliente não encontrado.");
    exit;
}
?>
        ...
        <form method="POST" action="<?=$url_base?>/functions/cliente/registrar.php">
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" name="celular" class="form-control" value="<?= htmlspecialchars($cliente['celular'] ?? '') ?>">
                </div>
                <div class="col-md-4 mb-3">
            ...
            <div class="row">
                ...
                <div class="col-md-1 mb-3">
                    ...
                    <input type="text" id="estado" name="estado" maxlength="2" class="form-control" value="<?= htmlspecialchars($cliente['estado'] ?? '') ?>">
                </div>
            </div>

            <div class="form-check mb-3">
                <input type="checkbox" class="form-check-input" id="preco_especial" name="preco_especial" <?= $cliente['preco_especial'] ? 'checked' : '' ?>>
